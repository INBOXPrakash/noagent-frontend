...
export default function ListingTabs({
  ...
  async function saveDraft() {
    ...
    try {
      ...
      alert('Your property has been saved as draft.')
    } catch {
  ...
  <div className="flex gap-4">
    ...
    <button
      onClick={async () => {
        ...
        alert('🚀 Your property is now LIVE!')
    ...
    <button
      ...
      className="border px-8 py-3 rounded font-semibold"
    >
      Save & Add Another
    </button>
